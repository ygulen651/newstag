...
export const bessProducts: ProductInfo[] = [
  {
    ...
    category: "Telekom güç çözümleri",
    image: "/images/789f8331-8ef5-44dd-9fee-538f29300149.jpg",
    imageFit: "contain",
    summary:
      "Telekom ve sınırlı şebeke uygulamaları için 48 V, 100 Ah ve 4,8 kWh kapasiteli kompakt LiFePO4 güç ünitesi.",
    description:
      "PBT-48100; telekom sistemleri, baz istasyonları ve sınırlı şebeke noktalarında kesintisiz enerji desteği sağlamak üzere geliştirilen, uzun ömürlü ve ölçeklenebilir bir LiFePO4 güç ünitesidir. Doğal soğutmalı kompakt 4U gövdesi ve dahili ısıtma özelliğiyle zorlu saha koşullarına uyum sağlar.",
    specs: [
      "LiFePO4 prizmatik pil teknolojisi",
      "48 V nominal gerilim",
      "100 Ah nominal kapasite",
      "4,8 kWh nominal enerji kapasitesi",
      "40-54,75 V çalışma gerilimi aralığı",
      "54,75 V maksimum şarj gerilimi",
      "50 A standart şarj/deşarj akımı",
      "100 A maksimum sürekli şarj/deşarj akımı",
      "10 A limitlenmiş şarj akımı",
      "4.000 ve üzeri döngü ömrü",
      "-20 °C ile 50 °C arasında şarj",
      "-10 °C ile 55 °C arasında deşarj",
      "-20 °C ile 55 °C arasında depolama",
      "RS485 haberleşme arayüzü",
      "Maksimum 16 paralel birimle ölçeklenebilirlik",
      "Doğal soğutma ve dahili ısıtma",
      "UV, OV, OC, UT, OT ve SC BMS korumaları",
      "IP20 koruma seviyesi",
      "398 × 472 × 178 mm (4U) boyut",
      "42,6 ±1 kg ağırlık ve 10 yıl garanti",
    ],
    options: ["48 V", "100 Ah", "4,8 kWh"],
  ...
  },
  {
    ...
    imageFit: "contain",
    summary:
      "Telekom ve saha operasyonları için 48 V, 150 Ah ve 7,2 kWh kapasiteli yüksek güçlü LiFePO4 enerji ünitesi.",
    description:
      "PBT-48150; telekom altyapıları ve sınırlı şebeke sahalarında daha yüksek enerji ihtiyacını karşılayan, uzun ömürlü ve paralel büyümeye uygun bir LiFePO4 güç ünitesidir. 5U gövdesi, dahili ısıtma sistemi ve gelişmiş BMS korumalarıyla farklı iklim koşullarında güvenilir çalışma sunar.",
    specs: [
      "LiFePO4 prizmatik pil teknolojisi",
      "48 V nominal gerilim",
      "150 Ah nominal kapasite",
      "7,2 kWh nominal enerji kapasitesi",
      "40-54,75 V çalışma gerilimi aralığı",
      "54,75 V maksimum şarj gerilimi",
      "75 A standart şarj/deşarj akımı",
      "150 A maksimum sürekli şarj/deşarj akımı",
      "4.000 ve üzeri döngü ömrü",
      "-20 °C ile 50 °C arasında şarj",
      "-20 °C ile 60 °C arasında deşarj ve depolama",
      "RS485 haberleşme arayüzü",
      "Maksimum 16 paralel birimle ölçeklenebilirlik",
      "Doğal soğutma, entegre ısıtıcı ve dahili iç ısıtma",
      "UV, OV, OC, UT, OT ve SC BMS korumaları",
      "Alarm, Run ve SOC LED göstergeleri",
      "IP20 koruma seviyesi",
      "398 × 472 × 223 mm (5U) boyut",
      "60 ±1 kg ağırlık",
      "10 yıl garanti",
    ],
    options: ["48 V", "150 Ah", "7,2 kWh"],
    icon: BatteryCharging,
  },
  {
    slug: "ev-tipi-bess",
